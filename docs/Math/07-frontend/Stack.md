...
**`clear()` là $O(1)$ nhờ GC** — cùng kỹ thuật với [Trie §3](../05-datastructures/Trie.md): bỏ tham chiếu thay vì duyệt xoá.
...
- Bản Java của cùng ý tưởng đóng gói: [MinHeap.md](../05-datastructures/MinHeap.md)
- `clear()` $O(1)$ nhờ GC: [Trie §3](../05-datastructures/Trie.md)
