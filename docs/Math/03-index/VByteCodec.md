...
> Cùng triết lý "tránh cấp phát trong vòng lặp nóng" với [PostingCursor](../06-datastructures/ArrayPostingCursor.md) — nơi autoboxing `List<Integer>` bị loại bỏ hoàn toàn.
...
| # | Lợi ích | Ở đâu |
|---|---|---|
| 1 | Two-pointer merge $O(m+n)$ | [PostingListMerger](../04-query/PostingListMerger.md) |
| 2 | Binary search $O(\log n)$ | [InvertedIndex §5](InvertedIndex.md) |
| 3 | **Delta encoding** | *trang này* |
| 4 | Galloping skip $O(\log d)$ | [ArrayPostingCursor](../06-datastructures/ArrayPostingCursor.md) |
...
- Lợi ích thứ tư của cùng bất biến: [ArrayPostingCursor](../06-datastructures/ArrayPostingCursor.md)
- Two-pointer merge: [PostingListMerger](../04-query/PostingListMerger.md)
