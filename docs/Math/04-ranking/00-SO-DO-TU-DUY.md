...
| **Ứng viên đến từ đâu** | [Sơ đồ tư duy tầng truy vấn](../03-query/00-SO-DO-TU-DUY.md) |
| **Các con số MRR đo bằng cách nào** | [Sơ đồ tư duy tầng đánh giá](../06-eval/00-SO-DO-TU-DUY.md) |
| Ma trận thưa CSR mà PageRank dùng | [SparseMatrix.md](../05-datastructures/SparseMatrix.md) |
| Decorator và Factory | [03-DECORATOR](../08-design-patterns/03-DECORATOR.md) · [02-FACTORY](../08-design-patterns/02-FACTORY.md) |
