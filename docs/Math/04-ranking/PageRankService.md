...
Chậm hơn **102 lần** — và cần **191,5 MB** RAM thay vì ~3,7 MB. Chi tiết ở [SparseMatrix](../05-datastructures/SparseMatrix.md).
...
- Cấu trúc nền: [SparseMatrix.md](../05-datastructures/SparseMatrix.md)
